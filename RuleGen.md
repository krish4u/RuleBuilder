...
User will select a count role condition from input from provided.</p>
<p><strong>Allowed</strong><br>
PARALLEL Condition should contain individual Roles on it’s left and right, with the left and right roles a parallel can be grouped.</p>
<blockquote>
