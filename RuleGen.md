...
<h1 id="welcome-to-rule-maker">Welcome to Rule Maker</h1>
<p>Hi! I am going to walk you through he CBXC Backoffice <strong>Rule Generator</strong> component.</p>
<h1 id="basic-understanding">Basic Understanding</h1>
<p>This is a front end component created using HTML, CSS and Javascript. It will fetch and push data to a middle layer.</p>
...
<img src="https://raw.githubusercontent.com/krish4u/RuleBuilder/master/RuleGen_Inputs.PNG" alt=""></p>
<p><strong>Restrictions on PARALLEL rule creation</strong></p>
<p>Condition should contain individual Roles on it’s left and right, with the left and right roles a parallel can be grouped.</p>
<blockquote>
<p><em>R [parallel] R</em></p>
</blockquote>
<p><img src="https://raw.githubusercontent.com/krish4u/RuleBuilder/master/Parallel%20Allowed.PNG" alt="enter image description here"></p>
<p>Don’t allow user to change condition from PARALLEL in a group when Next / Before condition is also PARALLEL.<br>
[R-Parallel-R-Parallel-R-Parallel-R]</p>
<p><strong>Not Allowed</strong><br>
R[and]R [parallel] R[or]R</p>
