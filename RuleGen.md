...
<p><strong>Restrictions on rule creation</strong></p>
<p>PARALLEL<br>
Condition should contain individual Roles on it’s left and right, with the left and right roles a parallel can be grouped.</p>
<blockquote>
