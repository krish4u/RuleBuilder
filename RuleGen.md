...
Parallel condition should contain individual Roles on it’s left and right.<br>
...
A parallel condition can be grouped with other<br>
<em><em>end</em></em></p>
